...
function SvgCustom90(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      <g fill="unset">
        <path d="M77.4 26L53 29.6V64c0 .6-.4 1-1 1h-4c-.6 0-1-.4-1-1V30.5L23.4 34H23c-1.5 0-2.8-1.1-3-2.6-.2-1.6.9-3.2 2.5-3.4l18.6-2.8c1.7-3.1 5-5.3 8.8-5.3 2.8 0 5.2 1.1 7 2.9L76.6 20c1.601-.2 3.2.9 3.4 2.5.2 1.7-.9 3.2-2.6 3.5z" />
