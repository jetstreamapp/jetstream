...
function SvgYourAccount(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      <path
        ...
        fill="unset"
      />
      <circle cx={62.1} cy={75.8} r={2.2} fill="unset" />
      <circle cx={72.9} cy={75.8} r={2.2} fill="unset" />
      <path
