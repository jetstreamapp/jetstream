...
function SvgServiceAppointment(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 100 100" aria-hidden="true" {...props}>
      <rect x={60.31} y={60.99} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <rect x={60.31} y={70.12} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <rect x={51.17} y={60.99} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <rect x={51.17} y={70.12} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <rect x={42.03} y={60.99} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <rect x={42.03} y={70.12} width={5.48} height={5.48} rx={0.91} ry={0.91} fill="#fff" />
      <path
