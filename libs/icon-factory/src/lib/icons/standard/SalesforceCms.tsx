...
function SvgSalesforceCms(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      ...
      />
      <path fill="none" d="M33.2 54h33.9c.9 0 1.7.8 1.7 1.7s-.8 1.7-1.7 1.7H33.2c-.9 0-1.7-.8-1.7-1.7s.8-1.7 1.7-1.7z" />
      <path fill="unset" d="M33.2 54h33.9c.9 0 1.7.8 1.7 1.7 0 .9-.8 1.7-1.7 1.7H33.2c-.9 0-1.7-.8-1.7-1.7 0-1 .8-1.7 1.7-1.7z" />
      <path fill="none" d="M36.7 62.5h27c.9 0 1.7.8 1.7 1.7 0 .9-.8 1.7-1.7 1.7h-27c-.9 0-1.7-.8-1.7-1.7 0-.9.7-1.7 1.7-1.7z" />
      <path fill="unset" d="M36.7 62.5h27c.9 0 1.7.8 1.7 1.7 0 .9-.8 1.7-1.7 1.7h-27c-.9 0-1.7-.8-1.7-1.7 0-.9.7-1.7 1.7-1.7z" />
      <path
        fill="unset"
