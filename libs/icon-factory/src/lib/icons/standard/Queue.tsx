...
function SvgQueue(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      ...
      />
      <ellipse fill="unset" cx={39.6} cy={51.6} rx={10.7} ry={11.8} />
      <path fill="unset" d="M55.7 29.5c-3.7 0-6.8 2.7-7.7 6.5 3.7 2.4 6.4 6.5 7.5 11.2h.2c4.4 0 8-4 8-8.9.1-4.8-3.5-8.8-8-8.8z" />
    </svg>
  );
}
