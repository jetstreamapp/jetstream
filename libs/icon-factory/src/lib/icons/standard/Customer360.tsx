...
function SvgCustomer360(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      ...
      />
      <g fill="unset">
        <path d="M61.7 57.1v1.1c0 1.4-1.1 2.5-2.5 2.5H39.5c-1.4 0-2.5-1.1-2.5-2.5v-1.1c0-3 3.5-4.8 6.8-6.2.1 0 .2-.1.3-.2.2-.1.5-.1.8 0 1.3.9 2.8 1.4 4.4 1.4s3.1-.5 4.4-1.3c.2-.2.5-.2.8 0 .1 0 .2.1.3.2 3.4 1.3 6.9 3.1 6.9 6.1z" />
