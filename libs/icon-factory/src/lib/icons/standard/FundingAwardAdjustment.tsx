...
function SvgFundingAwardAdjustment(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      ...
      />
      <path
        d="M80 62.82c0 6.11-4.95 11.06-11.06 11.06s-11.06-4.95-11.06-11.06 4.95-11.06 11.06-11.06S80 56.71 80 62.82zm-4.35-7.04h-4.19c-.27 0-.35.27-.14.51l1.33 1.47-2.44 2.69c-.14.15-.14.39 0 .57l1 1.11c.14.15.35.15.51 0l2.46-2.72 1.33 1.47c.22.24.46.15.46-.15v-4.6c0-.18-.16-.33-.32-.33zm-8.77 14.07h-4.54c-.21 0-.44-.26-.44-.47v-4.52c0-.29.29-.38.56-.15l1.47 1.44 2.65-2.64c.18-.15.41-.15.56 0l1.09 1.09c.15.15.15.41 0 .56l-2.65 2.67 1.44 1.47c.24.23.15.56-.15.56z"
        fill="unset"
        fillRule="evenodd"
      />
    </svg>
