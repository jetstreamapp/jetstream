...
function SvgAttach(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true" {...props}>
      <path
        d="M39.5 63.4a1.87 1.87 0 002.6 0l12.5-12.5a2.61 2.61 0 013.5 0 2.66 2.66 0 01.1 3.7l-.1.1-15.4 15.1a8.81 8.81 0 01-12.4 0l-.1-.1a8.81 8.81 0 010-12.4l27.2-27.2a8.81 8.81 0 0112.4 0l.1.1a8.81 8.81 0 010 12.4l-.1.1a1.82 1.82 0 00-.3 2.2 21.38 21.38 0 011.8 4.4 1.22 1.22 0 001.5.9l.6-.3c1-1 1.9-2 1.9-2a16.3 16.3 0 000-23.1H75a16.3 16.3 0 00-23.1 0l-27.1 27a16.3 16.3 0 000 23.1l.3.3a16.15 16.15 0 0022.9.1l.1-.1 15.4-15.4a10.18 10.18 0 10-14.2-14.6l-.4.4L36.6 58a2.13 2.13 0 000 2.8z"
        fill="unset"
      />
    </svg>
  );
