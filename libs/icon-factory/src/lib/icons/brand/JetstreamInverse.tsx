...
function SvgJetstreamInverse(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="100%"
      height="100%"
    ...
    >
      <g transform="matrix(1,0,0,1,-318,-166)">
        <g transform="matrix(1,0,0,1,91.8803,19.882)">
          <g transform="matrix(1.74877,0,0,1.74877,-273.02,-137.542)">
            <path
              d="M388.427,167.351C388.427,164.51 386.121,162.204 383.28,162.204L290.643,162.204C287.803,162.204 285.497,164.51 285.497,167.351L285.497,259.988C285.497,262.828 287.803,265.134 290.643,265.134L383.28,265.134C386.121,265.134 388.427,262.828 388.427,259.988L388.427,167.351Z"
              style={{
                fill: 'white',
              }}
            />
...
export default SvgJetstreamInverse;
