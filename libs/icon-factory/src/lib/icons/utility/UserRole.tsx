...
function SvgUserRole(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 520" fill="unset" aria-hidden="true" {...props}>
      <path d="M383 272a114 114 0 10114 114 115 115 0 00-114-114m20 124a24 24 0 01-9-2l-43 43a14 14 0 01-9 4 10 10 0 01-9-4 14 14 0 010-19l43-43a29 29 0 01-2-9 35 35 0 0134-38 24 24 0 019 2c2 0 2 2 1 3l-20 19a3 3 0 000 5l13 13a4 4 0 006 0l19-19c1-1 4-1 4 1a37 37 0 012 9 36 36 0 01-39 35M252 498c22 0 10-15 10-15a154 154 0 01-34-97 150 150 0 0114-64 8 8 0 012-3c7-14-7-15-7-15a121 121 0 00-19-1A197 197 0 0024 471c0 10 3 28 34 28h191z" />
      <circle cx={217} cy={149} r={129} />
    </svg>
  );
}
