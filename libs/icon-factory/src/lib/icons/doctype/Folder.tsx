...
function SvgFolder(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5600 6400" aria-hidden="true" {...props}>
      ...
      />
      <path fill="#90d0fe" d="M5148 1812H924a452 452 0 00-452 452v284l447-648h4235l446 649v-285a452 452 0 00-452-452" />
      <path
        fill="#1ab9ff"
        d="M457 5548h4691a452 452 0 00452-448V2348a452 452 0 00-452-448H925a452 452 0 00-452 452v2748a465 465 0 01-6 72 233 233 0 01-460 0 450 450 0 00450 376"
      />
    </svg>
  );
}
