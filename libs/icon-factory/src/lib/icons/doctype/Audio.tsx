    ...
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      <g fillRule="evenodd" clipRule="evenodd">
        <path
          ...
          fill="#379FD3"
        />
        <path d="M56 20.357v1H43.2s-6.312-1.26-6.128-6.707c0 0 .208 5.707 6.003 5.707H56z" fill="#2987C8" />
        <path d="M37.097.006v14.561c0 1.656 1.104 5.791 6.104 5.791h12.8L37.097.006z" opacity={0.5} fill="#fff" />
        <path
