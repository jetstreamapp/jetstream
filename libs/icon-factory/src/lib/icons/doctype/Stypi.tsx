    ...
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      <g fillRule="evenodd" clipRule="evenodd">
        <path
          ...
          fill="#DDD965"
        />
        <path d="M55.977 20.352v1H43.178s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z" fill="#C1BC45" />
        ...
        <path
          ...
          fill="#fff"
        />
        <path fill="#DBD75D" d="M13.741 43.553h13.675v1.643H13.741zm0-3.555h13.675v1.641H13.741zm0 7.109h8.867v1.643h-8.867z" />
      </g>
    </svg>
  );
}
