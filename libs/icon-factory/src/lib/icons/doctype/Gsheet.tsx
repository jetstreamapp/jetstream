  ...
  return (
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      ...
      <g fillRule="evenodd" clipRule="evenodd">
        <path d="M55.98 20.32v1H43.179s-6.312-1.26-6.127-6.707c0 0 .207 5.707 6.002 5.707H55.98z" fill="#189355" />
        <path d="M37.076-.031V14.53c0 1.656 1.104 5.791 6.104 5.791h12.801L37.076-.031z" opacity={0.5} fill="#fff" />
      </g>
    </svg>
  );
}
