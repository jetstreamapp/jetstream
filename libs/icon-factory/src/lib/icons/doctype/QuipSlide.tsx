...
function SvgQuipSlide(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 640" aria-hidden="true" {...props}>
      <path fill="#9050e9" d="M0 51v537c0 29 23 52 51 52h457c28 0 51-23 51-51V210L370 0H51A51 51 0 000 51z" />
      <path fill="#ece1f9" d="M370 0l190 210H421a52 52 0 01-52-52l1-158z" />
      <path fill="#5a1ba9" d="M370 159v10c0 28 23 52 52 52h138v-10H421a53 53 0 01-51-52z" />
      <path
        fill="unset"
