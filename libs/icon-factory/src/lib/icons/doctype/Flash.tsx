  ...
  return (
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      ...
      <g fillRule="evenodd" clipRule="evenodd">
        <path d="M55.961 20.346v1H43.162s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z" fill="#DE2D2D" />
        <path d="M37.059-.006v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.059-.006z" opacity={0.5} fill="#fff" />
      </g>
      <path
