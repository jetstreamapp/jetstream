...
function SvgGform(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      ...
      />
      <path fill="#45317C" d="M55.977 20.352v1H43.178s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z" />
      <path opacity={0.5} fill="unset" d="M37.074 0v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.074 0z" />
      <path
        fill="unset"
