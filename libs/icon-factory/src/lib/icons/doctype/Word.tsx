...
function SvgWord(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 56 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
      <g fillRule="evenodd">
        <path d="M5.11 0A5.07 5.07 0 000 5v53.88A5.07 5.07 0 005.11 64h45.78A5.07 5.07 0 0056 58.88v-38.6L37.06 0z" fill="#107CAD" />
