  ...
  return (
    <svg viewBox="0 0 56 64" aria-hidden="true" {...props}>
      ...
      <g fillRule="evenodd" clipRule="evenodd">
        <path d="M55.96 20.377v1H43.161s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707H55.96z" fill="#2D6FE4" />
        <path d="M37.058.025v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.058.025z" opacity={0.5} fill="#fff" />
      </g>
    </svg>
  );
}
