...
export const CreateNewObjectPermissionsCheckboxes = ({
  ...
  return (
    ...
    // checkbox its group context so "Allow Create" is announced with which profile it applies to. The
    // legend stays unstyled so the heading inside it looks as it did outside a fieldset
    <fieldset className="slds-form-element">
      <legend className="slds-p-horizontal_none">
