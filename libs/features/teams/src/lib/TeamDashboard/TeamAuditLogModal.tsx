...
const ACTION_DISPLAY_NAMES: Record<string, string> = {
  ...
  TEAM_SEATS_UPDATED: 'Seats Updated',
  TEAM_SEATS_DECREASE_SCHEDULED: 'Seat Decrease Scheduled',
  TEAM_SEATS_DECREASE_CANCELLED: 'Seat Decrease Cancelled',
  TEAM_SEATS_DECREASE_APPLIED: 'Seat Decrease Applied',
  TEAM_SEATS_BACKFILLED: 'Seats Backfilled',
  TEAM_MEMBER_ADD_BLOCKED_NO_SEATS: 'Member Add Blocked (No Seats)',
  TEAM_MEMBER_ADD_BLOCKED_PAST_DUE: 'Member Add Blocked (Past Due)',
