        ...
        <div className="slds-line-clamp_medium slds-m-top_x-small" title={csvField}>
          {isAdditionalMapping && (
            <Icon
              type="utility"
              icon="arrow_right"
              className="slds-icon slds-icon-text-weak slds-icon_xx-small slds-m-right_x-small"
        ...
        <Grid>
          ...
          {isAdditionalMapping ? (
            <button
              ...
              title="Remove this additional mapping"
              onClick={onRemoveRow}
            >
            ...
            onAddAdditionalMapping && (
              <button
                ...
                title={`Map ${csvField} to an additional Salesforce field`}
