...
export const LoadRecordsFieldMapping = memo<LoadRecordsFieldMappingProps>(
  ({
    ...
    function handleRemoveRow(mappingKey: string, triggerElement?: HTMLElement) {
      ...
      // Announced outside the updater (updaters must stay pure — StrictMode double-invokes them). No row
      // count: the mapping object also holds rows hidden by the mapped/unmapped filter and the search
