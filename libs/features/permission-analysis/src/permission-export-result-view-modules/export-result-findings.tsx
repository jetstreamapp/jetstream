  ...
  return {
    ...
    renderCell: (props) => {
      ...
      return (
        <>
          {base}
          {/* Hidden until focused: Id cells also hold the record lookup trigger, so a keyboard user
              stepping through the cell's controls must be able to see this one */}
          <button type="button" className="slds-assistive-text slds-assistive-text_focus">
