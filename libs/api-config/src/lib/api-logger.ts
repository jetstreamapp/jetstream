      ...
      try {
        return {
          ...
          headers: {
            ...
            'x-source': req.raw.headers[HTTP.HEADERS.X_SOURCE.toLowerCase()],
            'x-client-platform': req.raw.headers[HTTP.HEADERS.X_CLIENT_PLATFORM.toLowerCase()],
            'x-client-os-version': req.raw.headers[HTTP.HEADERS.X_CLIENT_OS_VERSION.toLowerCase()],
            'x-client-arch': req.raw.headers[HTTP.HEADERS.X_CLIENT_ARCH.toLowerCase()],
            'x-client-runtime': req.raw.headers[HTTP.HEADERS.X_CLIENT_RUNTIME.toLowerCase()],
            'x-client-install': req.raw.headers[HTTP.HEADERS.X_CLIENT_INSTALL.toLowerCase()],
