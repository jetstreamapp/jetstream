...
export const ENV = z
  .object({
    LOG_LEVEL: z.enum(['trace', 'debug', 'info', 'warn', 'error', 'fatal', 'silent']).optional().default('debug'),
    IS_CI: booleanSchema,
    // LOCAL OVERRIDE
    ...
    JETSTREAM_WORKER_URL: z.string().url().optional(),
    ...
    AUTH0_M2M_DOMAIN: z.string().optional(),
    ...
    MAILGUN_PUBLIC_KEY: z.string().optional(),
    MAILGUN_WEBHOOK_KEY: z.string().optional(),
    // SFDC
    SFDC_API_VERSION: z.string().default('60.0'),
