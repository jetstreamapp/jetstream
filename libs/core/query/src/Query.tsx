...
import { Spinner, StateDebugObserver } from '@jetstream/ui';
...
export const Query = ({ selectedOrg }: QueryProps) => {
  ...
  const [restore, errorMessage] = useQueryRestore(selectedOrg, null, false, { startRestore: startRestore, endRestore: endRestore });
