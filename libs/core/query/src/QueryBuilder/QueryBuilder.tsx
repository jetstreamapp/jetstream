...
import { Context, Fragment, FunctionComponent, useCallback, useRef, useState } from 'react';
...
export const QueryBuilder: FunctionComponent<QueryBuilderProps> = ({ selectedOrg }) => {
