...
import { initQueryFieldStateItem } from './query-fields-utils';
import {
 ...
 * @param query
 */
export async function restoreQuery(org: SalesforceOrgUi, query: Query, isTooling: boolean): Promise<QueryRestoreStateItems> {
