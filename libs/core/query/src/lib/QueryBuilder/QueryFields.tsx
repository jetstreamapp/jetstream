...
import { getQueryFieldBaseKey, getQueryFieldKey } from '@jetstream/core/shared-ui';
...
import { FieldWrapper, MapOf, Maybe, QueryFieldWithPolymorphic, QueryFields, SalesforceOrgUi } from '@jetstream/types';
import { AutoFullHeightContainer, SobjectFieldList } from '@jetstream/ui';
import isEmpty from 'lodash/isEmpty';
import { Fragment, FunctionComponent, useCallback, useEffect, useRef, useState } from 'react';
import { useRecoilState, useSetRecoilState } from 'recoil';
import * as fromQueryState from '../query.state';
import { getSelectedFieldsFromQueryFields, initQueryFieldStateItem } from '../utils/query-fields-utils';
...
export const QueryFieldsComponent: FunctionComponent<QueryFieldsProps> = ({
  selectedOrg,
  selectedSObject,
  isTooling,
  onSelectionChanged,
