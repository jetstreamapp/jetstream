...
import LoadRecordsResultsModal from '../load-records-results/LoadRecordsResultsModal';
...
export const MassUpdateRecordsDeploymentRow: FunctionComponent<MassUpdateRecordsDeploymentRowProps> = ({
  ...
  const [{ serverUrl, google_apiKey, google_appId, google_clientId }] = useRecoilState(fromJetstreamEvents.applicationCookieState);
