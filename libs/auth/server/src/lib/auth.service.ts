...
export function getProviders(): Providers {
  return {
    google: {
      ...
      type: 'oauth',
      label: 'Google',
      icon: `${ENV.JETSTREAM_SERVER_URL}/assets/images/third-party/google-login-icon.svg`,
    ...
    salesforce: {
      ...
      type: 'oauth',
      label: 'Salesforce',
      icon: `${ENV.JETSTREAM_SERVER_URL}/assets/images/third-party/salesforce-blue.svg`,
    ...
    credentials: {
      ...
      type: 'credentials',
      label: 'Jetstream',
      icon: `${ENV.JETSTREAM_SERVER_URL}/assets/images/jetstream-icon.svg`,
