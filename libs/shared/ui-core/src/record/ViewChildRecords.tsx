...
export const ViewChildRecords: FunctionComponent<ViewChildRecordsProps> = ({
  ...
  return (
    <>
      ...
      {/* Stays mounted during the reload it triggers: unmounting (or natively disabling) the button the
          user just activated drops focus to <body> (M17/M26) */}
      <Grid
        align="end"
        css={css`
          margin-top: -0.5rem;
      ...
      >
        ...
        >
          <button className="slds-button slds-m-right_small" {...ariaDisabledButtonProps(loading, () => fetchChildRecords(true))}>
