  ...
  return (
    <div className="slds-m-top_large">
      ...
      <p className="slds-text-body_small slds-text-color_weak slds-m-top_x-small">
        Inside any code editor: press <kbd>Alt</kbd>+<kbd>F1</kbd> for accessibility help, and <kbd>Ctrl</kbd>+<kbd>M</kbd> (<kbd>Ctrl</kbd>
        +<kbd>Shift</kbd>+<kbd>M</kbd> on Mac) to toggle whether <kbd>Tab</kbd> indents or moves focus out of the editor.
      </p>
    </div>
  );
}
