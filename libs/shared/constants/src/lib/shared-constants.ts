...
export const HTTP = {
  ...
  HEADERS: {
    ...
    X_SUPPORTS_TOKEN_ROTATION: 'X-Supports-Token-Rotation',
    X_CLIENT_PLATFORM: 'X-Client-Platform',
    X_CLIENT_OS_VERSION: 'X-Client-Os-Version',
    X_CLIENT_ARCH: 'X-Client-Arch',
    X_CLIENT_RUNTIME: 'X-Client-Runtime',
    X_CLIENT_INSTALL: 'X-Client-Install',
...
export const ANALYTICS_KEYS = {
  ...
  query_InlineEditUndo: 'query_InlineEditUndo',
  query_InlineEditRedo: 'query_InlineEditRedo',
  query_InlineEditRevert: 'query_InlineEditRevert',
  query_InlineEditPreview: 'query_InlineEditPreview',
  query_InlineEditDiscard: 'query_InlineEditDiscard',
  query_InlineEditDownload: 'query_InlineEditDownload',
  /** QUICK QUERY */
