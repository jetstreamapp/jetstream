      ...
      >
        ...
        <div
          ...
          css={css`
            ...
            /* slds-input__icon gave each button a 24px hit area. Without the class the button is the size
               of its 14px icon, so extend the clickable area around it without changing the layout. */
            & > .slds-button {
              position: relative;
            }
            & > .slds-button::after {
