...
describe('TimePicker', () => {
  ...
  describe('selection', () => {
    ...
    test('typing filters the options and Enter picks the first match', async () => {
      ...
      // The 300ms debounce is real wall-clock, and `nx run-many -t test` starves individual workers
      // badly enough that it has taken >4s to land, so allow far more than the nominal cost.
