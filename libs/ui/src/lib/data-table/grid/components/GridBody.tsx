  ...
  useEffect(() => {
    ...
    const tryFocus = () => {
      ...
      if (cellEl) {
        ...
        // Body/header cells carry the frozen class; summary cells are made sticky through their inline style
        const isFrozenCell = cellEl.classList.contains('jgrid-cell-frozen') || cellEl.style.position === 'sticky';
        if (scroller && !isFrozenCell) {
