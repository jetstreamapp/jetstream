...
describe('FileDownloadModal google upload', () => {
   ...
   */
  test('records the format and analytics after a queued upload closes the modal', async () => {
    const { trackEvent, emitUploadToGoogleEvent } = setup();
