...
export function NoTrailIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
          ...
          <g>
            ...
            <g transform="translate(91.000000, 147.000000)">
              ...
              <g>
                ...
                <path
                  ...
                  strokeLinejoin="round"
                ></path>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="146" cy="10" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="146" cy="86" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="10" cy="10" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="10" cy="86" r="3"></circle>
              </g>
            ...
            <g transform="translate(408.500000, 207.500000)">
              ...
              <g className="slds-illustration__stroke-secondary" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
                <polygon vectorEffect="non-scaling-stroke" points="17 0.323943662 34 54 -1.81721305e-12 54"></polygon>
                <path
                  vectorEffect="non-scaling-stroke"
            ...
            <g transform="translate(435.000000, 174.500000)">
              ...
              <g className="slds-illustration__stroke-secondary" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
                <polygon vectorEffect="non-scaling-stroke" points="26.5 0 52.5 87 0.5 87"></polygon>
                <path
                  vectorEffect="non-scaling-stroke"
...
export default NoTrailIllustration;
