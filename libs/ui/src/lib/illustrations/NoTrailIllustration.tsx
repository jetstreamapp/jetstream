...
function NoTrailIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
        ...
        <g transform="translate(-90.000000, -75.000000)">
          <g>
            ...
            <g transform="translate(91.000000, 147.000000)">
              ...
              <g>
                ...
                <path
                  ...
                  stroke-linejoin="round"
                ></path>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="146" cy="10" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="146" cy="86" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="10" cy="10" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="10" cy="86" r="3"></circle>
              </g>
            ...
            <g transform="translate(408.500000, 207.500000)">
              ...
              <g className="slds-illustration__stroke-secondary" stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
