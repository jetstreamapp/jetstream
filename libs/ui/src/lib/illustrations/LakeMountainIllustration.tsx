...
export function LakeMountainIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
          ...
          <g>
            ...
            <g transform="translate(110.000000, 62.000000)">
              <g transform="translate(223.000000, 36.000000)" fill="#FFFFFF">
                <polyline vectorEffect="non-scaling-stroke" points="0 30 30.5 0 132 102"></polyline>
              </g>
              <g>
                <polyline
                  vectorEffect="non-scaling-stroke"
            ...
            <g transform="translate(50.000000, 199.000000)" strokeLinecap="round" strokeWidth="3">
              <g transform="translate(31.000000, 17.000000)" className="slds-illustration__stroke-secondary" strokeLinejoin="round">
                <path
                  vectorEffect="non-scaling-stroke"
              ...
              <g className="slds-illustration__stroke-primary">
                <path
                  ...
                  strokeLinejoin="round"
                ></path>
                <path vectorEffect="non-scaling-stroke" d="M0,1.5 L6,1.5"></path>
                <path vectorEffect="non-scaling-stroke" d="M337,1.5 L477,1.5"></path>
                <path vectorEffect="non-scaling-stroke" d="M483,1.5 L501,1.5"></path>
              </g>
            </g>
            <g transform="translate(344.000000, 177.000000)">
              ...
              <g className="slds-illustration__stroke-primary" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
                <polygon vectorEffect="non-scaling-stroke" points="17.5 0.5 34 53.5 -1.82076576e-12 53.5"></polygon>
                <path
                  vectorEffect="non-scaling-stroke"
            ...
            <g transform="translate(302.000000, 152.000000)">
              ...
              <g className="slds-illustration__stroke-primary" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
                <polygon vectorEffect="non-scaling-stroke" points="26.5 0 52.6478873 78.5 0.647887324 78.5"></polygon>
                <path
                  vectorEffect="non-scaling-stroke"
            ...
            >
              <g>
                <path
                  ...
                  strokeLinejoin="round"
                ></path>
                <path vectorEffect="non-scaling-stroke" d="M234.5,95.5 L239,95.5"></path>
                <polygon
                  vectorEffect="non-scaling-stroke"
                  className="slds-illustration__fill-secondary"
                  strokeLinejoin="round"
