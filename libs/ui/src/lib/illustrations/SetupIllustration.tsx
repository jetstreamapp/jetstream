...
function SetupIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
          ...
          <g>
            ...
            <g transform="translate(116.000000, 80.000000)">
              <g transform="translate(106.000000, 4.000000)">
                <g>
                  <use className="slds-illustration__fill-secondary" fill-rule="evenodd" xlinkHref="#path-1"></use>
                  <rect className="slds-illustration__stroke-primary" stroke-width="3" x="78.5" y="48.5" width="17" height="25"></rect>
                </g>
                <rect className="slds-illustration__fill-secondary" x="72" y="30" width="30" height="22" rx="2"></rect>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-secondary" cx="87" cy="150" r="87"></circle>
                <circle
                  vector-effect="non-scaling-stroke"
                  className="slds-illustration__stroke-secondary"
                  stroke-width="6"
