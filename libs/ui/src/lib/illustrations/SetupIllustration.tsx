          ...
          <g>
            ...
            <g transform="translate(116.000000, 80.000000)">
              <g transform="translate(106.000000, 4.000000)">
                <g>
                  <use className="slds-illustration__fill-secondary" fillRule="evenodd" xlinkHref="#path-1"></use>
                  <rect className="slds-illustration__stroke-primary" strokeWidth="3" x="78.5" y="48.5" width="17" height="25"></rect>
                </g>
                <rect className="slds-illustration__fill-secondary" x="72" y="30" width="30" height="22" rx="2"></rect>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-secondary" cx="87" cy="150" r="87"></circle>
                <circle
                  vectorEffect="non-scaling-stroke"
                  className="slds-illustration__stroke-secondary"
                  strokeWidth="6"
              ...
              <g transform="translate(112.000000, 35.000000)" fill="#FFFFFF">
                <circle vectorEffect="non-scaling-stroke" cx="81" cy="119" r="73"></circle>
              ...
              <g className="slds-illustration__stroke-primary" strokeWidth="3">
                ...
                ></path>
                <path vectorEffect="non-scaling-stroke" d="M27,241.5 L392,241.5" strokeLinecap="round"></path>
                <path vectorEffect="non-scaling-stroke" d="M0,241.5 L20,241.5" strokeLinecap="round"></path>
                <circle vectorEffect="non-scaling-stroke" cx="193" cy="154" r="87"></circle>
                <circle vectorEffect="non-scaling-stroke" cx="193" cy="154" r="73"></circle>
              </g>
            </g>
