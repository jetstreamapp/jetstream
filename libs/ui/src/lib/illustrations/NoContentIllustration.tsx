...
export function NoContentIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
        ...
        <g transform="translate(-70.000000, -94.000000)">
          <g>
            ...
            <g
              ...
              strokeWidth="3"
            >
              <polyline vectorEffect="non-scaling-stroke" points="0 38 47.5 0 80.5 26"></polyline>
              <polyline vectorEffect="non-scaling-stroke" points="71 17 80.5 9 113 36"></polyline>
            </g>
            ...
            <g transform="translate(105.000000, 189.000000)">
              ...
              <g transform="translate(106.000000, 62.000000)" className="slds-illustration__fill-secondary">
                <polygon
                  vectorEffect="non-scaling-stroke"
              ...
              <g>
                ...
                <path
                  ...
                  transform="translate(96.500000, 24.500000) scale(-1, 1) rotate(90.000000) translate(-96.500000, -24.500000) "
                ></path>
                <rect className="slds-illustration__fill-secondary" x="106.5" y="0.5" width="110" height="48"></rect>
                <rect
                  className="slds-illustration__stroke-primary"
                  strokeWidth="3"
                  strokeLinecap="round"
                ...
                <path
                  ...
                  strokeLinecap="round"
                ></path>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="72" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="107" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="72" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="107" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="72" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="107" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="72" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="107" r="3"></circle>
                <path
                  vectorEffect="non-scaling-stroke"
