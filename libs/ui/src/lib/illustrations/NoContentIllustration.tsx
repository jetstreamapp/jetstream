...
function NoContentIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
        ...
        <g transform="translate(-70.000000, -94.000000)">
          <g>
            <g transform="translate(124.500000, 222.000000)">
              ...
              <g className="slds-illustration__stroke-secondary" stroke-linecap="round" stroke-width="3">
                <polygon
                  vector-effect="non-scaling-stroke"
            ...
            <g transform="translate(105.000000, 189.000000)">
              ...
              <g>
                ...
                <path
                  ...
                  stroke-linecap="round"
                ></path>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="72" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="107" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="72" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="107" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="72" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="107" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="72" r="3"></circle>
                <circle vector-effect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="107" r="3"></circle>
                <path
                  vector-effect="non-scaling-stroke"
