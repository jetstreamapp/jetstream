...
export function FishIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg className="slds-illustration__svg" viewBox="0 0 466 297" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(-69.000000, -68.000000)">
          <g>
            ...
            <g transform="translate(373.000000, 263.000000)">
              ...
              <g transform="translate(0.000000, 25.000000)">
                ...
                <path
                  ...
                  strokeLinecap="round"
                ></path>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="20" cy="31" r="4"></circle>
              </g>
            </g>
            <g transform="translate(244.500000, 274.000000) scale(-1, 1) translate(-244.500000, -274.000000) translate(190.000000, 251.000000)">
              ...
              <g transform="translate(1.000000, 19.000000)" className="slds-illustration__fill-secondary">
                <path
                  vectorEffect="non-scaling-stroke"
              ...
              <g>
                ...
                <path
                  ...
                  strokeLinecap="round"
                ></path>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="15.5" cy="22.5" r="2.5"></circle>
              </g>
            </g>
