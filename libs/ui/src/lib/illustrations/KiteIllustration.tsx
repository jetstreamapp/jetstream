...
export function KiteIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
          ...
          <g>
            ...
            <g transform="translate(197.000000, 68.000000)">
              <g transform="translate(152.000000, 0.000000)" fill="#FFFFFF">
                <polygon vectorEffect="non-scaling-stroke" points="18 0 0 62 76 100 82 18"></polygon>
              </g>
              <g transform="translate(152.000000, 4.000000)" className="slds-illustration__fill-secondary">
                <path
                  vectorEffect="non-scaling-stroke"
              ...
              <g className="slds-illustration__stroke-primary" strokeWidth="3">
                ...
                ></polygon>
                <path vectorEffect="non-scaling-stroke" d="M170,0 L226,97" strokeLinecap="round" strokeLinejoin="round"></path>
                <path
                  vectorEffect="non-scaling-stroke"
                ...
                ></path>
                <circle vectorEffect="non-scaling-stroke" cx="107" cy="148" r="9"></circle>
                <path
                  vectorEffect="non-scaling-stroke"
...
export default KiteIllustration;
