...
function CampingIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
        ...
        <g transform="translate(-64.000000, -98.000000)">
          <g>
            ...
            <g transform="translate(231.000000, 232.500000)">
              ...
              <g transform="translate(1.000000, 0.000000)" className="slds-illustration__stroke-primary" stroke-width="3">
