...
export function NoAccessIllustration(_props: React.SVGProps<SVGSVGElement>) {
  return (
        ...
        <g transform="translate(-70.000000, -95.000000)">
          <g>
            ...
            <g transform="translate(105.000000, 203.000000)">
              ...
              <g transform="translate(106.000000, 5.000000)" className="slds-illustration__fill-secondary">
                <polygon
                  vectorEffect="non-scaling-stroke"
              ...
              <g>
                ...
                <path
                  ...
                  strokeLinecap="round"
                ></path>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="58" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="164" cy="93" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="58" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="255" cy="93" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="58" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="145" cy="93" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="58" r="3"></circle>
                <circle vectorEffect="non-scaling-stroke" className="slds-illustration__fill-primary" cx="116" cy="93" r="3"></circle>
                <path
                  vectorEffect="non-scaling-stroke"
...
export default NoAccessIllustration;
