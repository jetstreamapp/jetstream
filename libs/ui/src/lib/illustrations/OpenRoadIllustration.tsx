  ...
  return (
    <svg className="slds-illustration__svg" viewBox="0 0 454 272" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" transform="translate(-65 -74)">
        ...
        <g className="slds-illustration__stroke-primary" strokeLinecap="round" strokeWidth="3" transform="translate(67 253)">
          <path vectorEffect="non-scaling-stroke" d="M0 1.5L450 1.5M284 2L419 61M282 2L65 91M443 1.5L449 1.5"></path>
        </g>
        ...
        <g className="slds-illustration__stroke-secondary" strokeLinecap="round" strokeWidth="3" transform="translate(292 139)">
          <path
            vectorEffect="non-scaling-stroke"
            d="M44,17.5 L63,17.5 C62.2789714,12.0723971 64.081543,7.53186978 68.4077148,3.87841797 C73.3754883,-0.195556641 79.2734375,0.717773438 82.440918,2.12353516 C85.6083984,3.52929687 87.9606934,5.46069336 89.5913086,9.10524041 C90.2822266,10.6397351 90.7517904,11.9379883 91,13"
          ></path>
        ...
        <g transform="translate(439.5 227.5)">
          ...
          ></path>
          <g className="slds-illustration__stroke-primary" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
            <polygon vectorEffect="non-scaling-stroke" points="17 -4.676 34 54 0 54"></polygon>
            <path
              vectorEffect="non-scaling-stroke"
        ...
        <g transform="translate(141.852 213.5)">
          ...
          >
            <polygon vectorEffect="non-scaling-stroke" points="26.648 0 52.648 87 .648 87"></polygon>
            <path
              vectorEffect="non-scaling-stroke"
        ...
        <g transform="translate(168 57)">
          <circle vectorEffect="non-scaling-stroke" cx="64" cy="64" r="23" className="slds-illustration__fill-secondary"></circle>
          <path
            vectorEffect="non-scaling-stroke"
            className="slds-illustration__stroke-secondary"
          ...
          ></path>
          <g className="slds-illustration__stroke-primary" strokeWidth="3" transform="translate(41 41)">
