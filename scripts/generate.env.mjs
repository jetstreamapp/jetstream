...
const replacements = [
  ...
  ['JETSTREAM_AUTH_SSO_SECRET=', `JETSTREAM_AUTH_SSO_SECRET='${generateRandomBase64(32)}'`],
  ['JETSTREAM_AUTH_WEB_EXT_JWT_SECRET=', `JETSTREAM_AUTH_WEB_EXT_JWT_SECRET='${generateRandomBase64(32)}'`],
