...
// Null prototype so a scan key like "__proto__" is stored as an ordinary entry instead of mutating
// the object's prototype (scan keys come from JSON files on disk)
