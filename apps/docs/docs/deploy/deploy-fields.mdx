...
<div style={{ marginBottom: '1rem' }}>
  <span style={{ marginRight: '.5rem' }}>ℹ️ </span> If you have configured fields on the page, you may want to click{' '}
  <code>Reset Fields</code> before importing as existing fields on the page will not be updated.
</div>
