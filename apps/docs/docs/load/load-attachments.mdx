...
Our pro plans include 1GB uploads. The Browser extension and Desktop Application have unlimited upload sizes.

:::

- Upload limits are tiered: Free users can upload zip files up to `50MB`, paid users up to `1GB`, and Desktop Application or Browser Extension users have unlimited upload sizes. If your data exceeds your plan's limit, split your attachments into multiple loads or upgrade your plan.
