...
<img src={require('./load-related-example-1.png').default} alt="Example load file with a linked column" />
...
| The field does not exist on the object                                       | A column header has a typo, or your user does not have access to the field                                                             | Correct the field API name in row 5, or check field-level security                                                                  |
