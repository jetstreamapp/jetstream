...
Your history records will be synced across your devices and optional to the browser extension, if enabled.
...
History sync is **opt-in when using the browser extension** in case you want to favor privacy over convenience, clicking on the browser extension icon in Chrome will give you the option to enable this feature.

View the browser extension options for more details [browser extension](../browser-extension/browser-extension.mdx).
