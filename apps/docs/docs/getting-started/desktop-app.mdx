...
The desktop application keeps itself up to date automatically. See
[Desktop App Updates](./desktop-app-updates.mdx) to learn how updates work, how to turn automatic
updates off, and how IT teams can manage updates across an organization.
