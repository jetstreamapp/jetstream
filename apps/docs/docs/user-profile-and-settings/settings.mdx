...
- **Optimize code editors for screen readers**: Switches the SOQL, Apex, and formula editors to Monaco's screen reader mode, which announces line content and enables assistive navigation. See the [accessibility page](/accessibility) for the keyboard shortcuts that work in every editor.
