...
When bulk editing records from query results, opening the view/download results modal did nothing. This now works correctly, and the Google Drive file picker no longer hides its parent modal. Reported in [#1328](https://github.com/jetstreamapp/jetstream/issues/1328).
