...
Desktop 1.1.0 adds Windows support alongside macOS. The Windows build is code-signed and handles install, update, and uninstall correctly, including Start Menu shortcuts. If you tried the desktop app previously on Windows, grab the new installer.
