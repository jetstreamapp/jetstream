...
routes.post('/callback/:provider', STRICT_AuthRateLimit, authController.routeDefinition.callback.controllerFn());
...
routes.post('/password/reset/init', STRICT_2X_AuthRateLimit, authController.routeDefinition.requestPasswordReset.controllerFn());
