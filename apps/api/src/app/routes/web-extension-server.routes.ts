...
const CRASH_RateLimit = createRateLimit('web-ext_crash', {
...
routes.post('/crash', CRASH_RateLimit, express.raw({ type: () => true, limit: '1mb' }), crashTunnelController.crashTunnelHandler);
