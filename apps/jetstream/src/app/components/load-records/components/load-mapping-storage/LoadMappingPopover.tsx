...
export const LoadMappingPopover: FunctionComponent<LoadMappingPopoverProps> = ({ sobject, csvFields, objectFields, onLoadMapping }) => {
  ...
  const setFieldMappingState = useSetRecoilState(savedFieldMappingState);
  const savedMappingsForObject = useRecoilValue(selectSavedFieldMappingState({ sobject, csvFields, objectFields }));
