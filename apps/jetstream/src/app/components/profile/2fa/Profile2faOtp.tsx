    ...
    <Card
      ...
      actions={
        <>
          ...
          {isConfigured && (
            <DropDown dropDownClassName="slds-dropdown_actions" position="right" items={menuItems} onSelected={handleMenuAction} />
          )}
        </>
      }
    >
      ...
      {editIsActive && otp2fa && (
        <form onSubmit={handleSave}>
          ...
          <p>Or enter the following code in your authenticator app: {otp2fa.secretToken}</p>
