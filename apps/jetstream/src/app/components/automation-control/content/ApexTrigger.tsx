...
import { CheckboxToggle, Grid, GridCol, SalesforceLogin, Toast } from '@jetstream/ui';
...
export const AutomationControlContentApexTrigger: FunctionComponent<AutomationControlContentApexTriggerProps> = ({
  ...
  return (
    <Fragment>
      {isReadOnly && (
        <Toast type="warning" showIcon={true}>
          Apex Triggers are not yet supported for production orgs.
        </Toast>
      )}
