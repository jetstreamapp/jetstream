...
import { getMapOf, orderObjectsBy, orderStringsBy, pluralizeFromNumber } from '@jetstream/shared/utils';
...
import { ChangeEvent, Fragment, FunctionComponent, useContext, useRef, useState } from 'react';
  ...
  return [
    {
      ...
      summaryFormatter: (args) => {
        if (args.row.type === 'HEADING') {
          return <SummaryFilterRenderer columnKey={`${profile}-layout-assignment`} label="Page Layout" />;
        }
        return undefined;
      },
    },
    {
      ...
      summaryFormatter: (args) => {
        if (args.row.type === 'HEADING') {
          return <SummaryFilterRenderer columnKey={`${profile}-assigned-record-type`} label="Visible" />;
        }
        return undefined;
      },
    },
    {
      ...
      summaryFormatter: (args) => {
        if (args.row.type === 'HEADING') {
          return <SummaryFilterRenderer columnKey={`${profile}-default-record-type`} label="Default" />;
        }
        return undefined;
      },
    },
