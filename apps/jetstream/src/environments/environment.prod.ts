export const environment = {
  ...
  STRIPE_TEAM_ANNUAL_PRICE_ID: import.meta.env.NX_PUBLIC_STRIPE_TEAM_ANNUAL_PRICE_ID,
  STRIPE_TEAM_MONTHLY_PRICE_ID: import.meta.env.NX_PUBLIC_STRIPE_TEAM_MONTHLY_PRICE_ID,
