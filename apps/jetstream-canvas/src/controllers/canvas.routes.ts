...
import { routeDefinition as dataSyncController } from './jetstream-data-sync.canvas.controller';
import { routeDefinition as preferencesController } from './preferences.canvas.controller';
import { handleJsonResponse, RequestOptions } from './route.utils';
import { routeDefinition as bulkApiController } from './sf-bulk-api.canvas.controller';
import { routeDefinition as bulkQuery20ApiController } from './sf-bulk-query-20-api.canvas.controller';
import { routeDefinition as metadataToolingController } from './sf-metadata-tooling.canvas.controller';
import { routeDefinition as miscController } from './sf-misc.canvas.controller';
import { routeDefinition as queryController } from './sf-query.canvas.controller';
import { routeDefinition as recordController } from './sf-record.canvas.controller';
import { routeDefinition as userController } from './user.canvas.controller';
...
router.get('/api/me', async (req) => {
  ...
  return handleJsonResponse({
    ...
    name: user.fullName,
    emailVerified: true,
    picture: user.profileThumbnailUrl || null,
    preferences: {
 ...
 * ************************************
 */
router.get('/api/me/preferences', preferencesController.getPreferences.controllerFn());
router.patch('/api/me/preferences', preferencesController.savePreferences.controllerFn());
