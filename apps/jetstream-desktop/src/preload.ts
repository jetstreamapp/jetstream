...
const API: ElectronAPI = {
  ...
  dataHistoryRequest: (payload) => ipcRenderer.invoke('dataHistoryRequest', payload),
  getDataHistoryFolder: () => ipcRenderer.invoke('getDataHistoryFolder'),
  setDataHistoryFolder: (payload) => ipcRenderer.invoke('setDataHistoryFolder', payload),
