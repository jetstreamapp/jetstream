 ...
 * 1. Extension hook fetches Google config from API via service worker message
 * 2. Extension opens this page in a popup window with mode, nonce, and Google config as query params
...
export function useWebExtensionGooglePickerState() {
  ...
  }, [mode, nonce, appId, apiKey, clientId, googleAccessToken, googleAccessTokenExpiresAt, sendResultToOpener, tryCloseWindow]);
