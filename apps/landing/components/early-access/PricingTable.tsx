...
export const PricingTable = () => (
  <div className="bg-gradient-to-r from-indigo-600 to-blue-700 py-16 px-4 sm:py-24 sm:px-6 lg:bg-none lg:flex lg:items-center lg:justify-end lg:px-0 lg:pl-8">
