...
export function VerifyEmailOr2fa({ csrfToken, pendingVerifications }: VerifyEmailOr2faProps) {
  ...
  const [pendingVerificationold, ...otherVerificationMethods] = pendingVerifications;
  ...
  const onSubmit = async (payload: Form) => {
    ...
    // FIXME: we want to show error message on same page without a redirect
    ...
    <Fragment>
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <ChangeAuthenticationMethod activeFactor={activeFactor} pendingVerifications={pendingVerifications} onChange={setActiveFactor} />
