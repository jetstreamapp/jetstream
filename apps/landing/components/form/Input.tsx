...
import { DetailedHTMLProps, HTMLAttributes, InputHTMLAttributes, LabelHTMLAttributes, useId } from 'react';
...
export function Input({ label, error, labelProps, inputProps, inputContainerProps }: InputProps) {
  const id = useId();
