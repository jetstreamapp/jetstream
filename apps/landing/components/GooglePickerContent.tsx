...
import type { PickerStatus } from '../hooks/google-picker-shared';

const email = 'support@getjetstream.app';

const STATUS_DISPLAY: Record<PickerStatus, string | null> = {
  idle: 'Initializing...',
...
interface GooglePickerContentProps {
  status: PickerStatus;
  errorMessage: Maybe<string>;
  handleAuthorize: () => void;
}

export function GooglePickerContent({ status, errorMessage, handleAuthorize }: GooglePickerContentProps) {
