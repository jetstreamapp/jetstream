    ...
    <main className="grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 sm:my-4 md:my-12">
      <div className="py-16">
        <div className="text-center">
          <p className="text-sm font-semibold text-cyan-700 uppercase tracking-wide">Goodbye</p>
          ...
          <div className="mt-6">
            <Link href={ROUTES.HOME} className="text-base font-medium text-cyan-700 hover:text-cyan-600">
