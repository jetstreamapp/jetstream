...
export const Profile = () => {
  ...
  const getUserProfile = useCallback(async () => {
    ...
    try {
      ...
      rollbar.error('Settings: Error fetching user', getErrorMessageAndStackObj(ex));
  ...
  async function handleSave() {
    try {
      ...
      rollbar.error('Settings: Error updating user', getErrorMessageAndStackObj(ex));
    } finally {
      setLoading(false);
      setEditMode(false);
    }
  ...
  async function handleSetPassword(password: string) {
    try {
      ...
      fireToast({
        message: getErrorMessage(ex) || 'There was a problem resetting your password. Try again or file a support ticket for assistance.',
        type: 'error',
      });
      rollbar.error('Settings: Error setting password', getErrorMessageAndStackObj(ex));
    }
  }
  ...
  async function handleResetPassword() {
    try {
      ...
      rollbar.error('Settings: Error resetting password', getErrorMessageAndStackObj(ex));
    }
  }
  ...
  async function handleRemovePassword() {
    try {
      ...
      rollbar.error('Settings: Error removing password', getErrorMessageAndStackObj(ex));
    }
  }
