...
const getJobs = createRoute(routeDefinition.getJobs.validators, async ({ query, jetstreamConn }, _req) => {
  try {
    const options = query;
...
const abortJob = createRoute(routeDefinition.abortJob.validators, async ({ params, jetstreamConn }, _req) => {
  try {
    const jobId = params.jobId;
...
const deleteJob = createRoute(routeDefinition.deleteJob.validators, async ({ params, jetstreamConn }, _req) => {
  try {
    const jobId = params.jobId;
