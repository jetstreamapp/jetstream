...
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| E2E page sweep  | axe-core WCAG 2.1 A/AA scan of every top-level app route + key interactive states                                                                                                                    | `pnpm playwright:test:a11y` (needs the E2E server; runs in CI inside the e2e shards) |
...
(`scripts/a11y-lint-ratchet.mjs`, run by the pre-commit hook and the required CI `build-and-test` job) holds the line:
